 ...
 * @author taichi
 */
public class HackByteBuf extends ByteBuf {
	...
	private HackByteBuf swapped;

	public HackByteBuf(ByteBufAllocator alloc) {
		this(alloc, ByteOrder.BIG_ENDIAN);
	}

	private HackByteBuf(ByteBufAllocator alloc, ByteOrder order) {
		if (alloc == null) {
	...
	public ByteBuf order(ByteOrder endianness) {
		...
		HackByteBuf swapped = this.swapped;
		if (swapped != null) {
			return swapped;
		}

		this.swapped = swapped = new HackByteBuf(alloc(), endianness);
		return swapped;
	}
